...
require(["d3"], function(d3) {
    ...
    d3.json("graph.json", function(error, graph) {
		...
		link.append("text")
            .text(function(d) { return "Number of Calls: " + d.call_count + 
				"\n" + "Number of Sent Messages: " + d.sent_messages_count});
		...
		link.on("mouseover", function(d) {
			d3.select(link).select("text").style("visibility", "visible")
		})
    });
});